...
def run_exp(data_folders,
    ...
    log.info("Model:\n{:s}".format(str(model)))
    model.load_state_dict(th.load('TUHmodel/shallow_model.pt'))
    #for param in model.parameters():
    #   param.requires_grad = False
    
    # Parameters of newly constructed modules have requires_grad=True by default
    #model.classifier=model.classifier[:-2]
    #model.add_module("softmaxx", nn.LogSoftmax(dim=1))
    #model.add_module("squeezee", Expression(_squeeze_final_output))


    # # # #Removing layers
    # model.drop_2 = Identity()
    # model.conv_2 = Identity()
    # model.bnorm_2 = Identity()
    # model.nonlin_2 = Identity()
    # model.pool_2 = Identity()
    # model.pool_nonlin_2 = Identity()
    # model.drop_3 = Identity()
    # model.conv_3 = Identity()
    # model.bnorm_3 = Identity()
    # model.nonlin_3 = Identity()
    # model.pool_3 = Identity()
    # model.pool_nonlin_3 = Identity()
    # model.drop_4 = Identity()
    # model.conv_4= Identity()
    # model.bnorm_4= Identity()
    # model.nonlin_4 = Identity()
    # model.pool_4= Identity()
    #
    #
    # model.pool_nonlin_4 = Identity()
    #
    # model.conv_classifier = Identity()
    # model.softmax = Identity()
    # model.squeeze = Identity()
    log.info("Model:\n{:s}".format(str(model)))
    if cuda:
        model.cuda()
...
if __name__ == "__main__":
    ...
    th.save(exp.model.state_dict(), 'model/shallowtransfer.pt')
